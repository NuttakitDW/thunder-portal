...
describe("Resolving example", () => {
  ...
  describe("Fill", () => {
    it("should swap Ethereum USDC -> Bsc USDC. Single fill only", async () => {
      ...
      console.log('initialBalances.src.user', initialBalances.src.user);
      console.log('resultBalances.src.user', resultBalances.src.user);
      expect(resultBalances.src.resolver - initialBalances.src.resolver).toBe(
        order.makingAmount
      );
      console.log('resultBalances.src.resolver - initialBalances.src.resolver', resultBalances.src.resolver - initialBalances.src.resolver);
      ...
      // 1000000000n
      console.log('resultBalances.dst.user - initialBalances.dst.user', resultBalances.dst.user - initialBalances.dst.user);
      console.log('order.takingAmount', order.takingAmount);
      expect(initialBalances.dst.resolver - resultBalances.dst.resolver).toBe(
        order.takingAmount
      );
      console.log('initialBalances.dst.resolver - resultBalances.dst.resolver', initialBalances.dst.resolver - resultBalances.dst.resolver);
      console.log(order.takingAmount)
    });
  });
});
